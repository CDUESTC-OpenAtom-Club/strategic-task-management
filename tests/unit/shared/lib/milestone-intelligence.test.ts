...
describe('Milestone Intelligence', () => {
  it('should highlight overdue milestones as exception', () => {
    ...
    const indicator = makeIndicatorWithMilestones([{ id: 'm1', name: 'Past', deadline, targetProgress: 0, status: 'pending' }], 0)
  ...
  it('should show upcoming milestone as warning when close', () => {
    ...
    const indicator: StrategicIndicator = makeIndicatorWithMilestones([{ id: 'm2', name: 'Upcoming', deadline, targetProgress: 10, status: 'pending' }], 0)
  ...
  it('getMilestonesTooltip should map basic milestone fields', () => {
    ...
    const indicator: StrategicIndicator = makeIndicatorWithMilestones([{ id: 'm3', name: 'M3', deadline, targetProgress: 70, status: 'pending' }], 70)
