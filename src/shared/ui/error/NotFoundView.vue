    ...
    <div class="not-found-content">
      ...
      <div class="illustration">
        <svg viewBox="0 0 400 300" class="not-found-svg">
          ...
          <circle cx="60" cy="200" r="5" fill="#9333ea" class="dot dot-3" />
        </svg>
      </div>
      ...
      <div class="quick-links">
        ...
        <el-button link type="primary" @click="handleNavigate('/dashboard')">仪表盘</el-button>
        <el-button link type="primary" @click="handleNavigate('/tasks')">战略任务</el-button>
        <el-button link type="primary" @click="handleNavigate('/indicators')">指标列表</el-button>
      </div>
    </div>
  </div>
</template>
...
@keyframes float {
  0%,
  100% {
    transform: translate(280px, 80px) rotate(0deg);
  }
  50% {
    transform: translate(280px, 70px) rotate(5deg);
  }
}
