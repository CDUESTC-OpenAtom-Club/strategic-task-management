...
import { useIndicatorStore, canDeleteIndicator, canDistributeIndicator, IndicatorList, IndicatorDetailDialog, IndicatorDistributionDialog } from '@/features/strategic-indicator'
