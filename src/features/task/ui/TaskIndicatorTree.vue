...
const calculatePath = (indicatorId: string): string[] => {
  ...
  const dept = indicator.responsibleDept || '未分�?
...
const treeData = computed(() => {
  ...
  indicators.forEach(ind => {
    const dept = ind.responsibleDept || '未分�?
    if (!deptMap.has(dept)) {
      deptMap.set(dept, [])
    }
            ...
            <template #content>
              <div class="stats-tooltip">
                <div class="stats-row">
                  ...
                  <span class="stats-value">{{ data.stats.total }}�?/span>
                </div>
                <div class="stats-row normal">
                  <span class="stats-label">正常:</span>
                  <span class="stats-value">{{ data.stats.normal }}�?/span>
                </div>
                <div class="stats-row warning">
                  <span class="stats-label">预警:</span>
                  <span class="stats-value">{{ data.stats.warning }}�?/span>
                </div>
                <div class="stats-row ahead">
                  <span class="stats-label">超前:</span>
                  <span class="stats-value">{{ data.stats.ahead }}�?/span>
                </div>
              </div>
            </template>
