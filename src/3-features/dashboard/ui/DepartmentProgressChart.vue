...
import type { DepartmentProgress } from '@/shared/types'
...
<template>
  <div class="department-progress-chart">
    ...
    <div v-for="item in displayedDepartments" :key="item.dept" class="dept-item">
    ...
    <div v-if="needShowMore" class="show-more-section">
      <el-button text type="primary" class="show-more-btn" @click="toggleShowAll">
